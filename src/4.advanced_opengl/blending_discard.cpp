...
int main(int argc, char const *argv[])
{
    ...
    Shader shader(addpath("3.1.blending.vs"), addpath("3.1.blending.fs"));
    ...
    unsigned int cubeTexture =
                 ...
                 transparentTexture =
                     loadTexture("/Users/peterhuang98/test_code/C++/learn_opengl/resources/textures/grass.png");
    ...
    vector<glm::vec3> vegetation{glm::vec3(-1.5f, 0.0f, -0.48f), glm::vec3(1.5f, 0.0f, 0.51f),
                                 ...
                                 glm::vec3(0.5f, 0.0f, -0.6f),   glm::vec3(0.0f, 0.0f, 0.0f)};
