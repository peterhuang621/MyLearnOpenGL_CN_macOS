...
int main(int argc, char const *argv[])
{
    ...
    Shader shader(addpath("5.1.framebuffers.vs"), addpath("5.1.framebuffers.fs"));
    Shader screenShader(addpath("5.1.framebuffers_screen.vs"), addpath("5.1.framebuffers_screen.fs"));
    ...
    // MacOS Retina should gets double!
