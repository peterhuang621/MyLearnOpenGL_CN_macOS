...
float yaw = -90.0f, pitch = 0.0f, lastX = float(SCR_WIDTH) / 2.0, lastY = float(SCR_HEIGHT) / 2.0, fov = 45.0f;
...
int main(int argc, char const *argv[])
{
    ...
    Shader ourShader("/Users/peterhuang98/test_code/C++/learn_opengl/src/1.getting_started/7.3.camera.vs", "/Users/peterhuang98/test_code/C++/learn_opengl/src/1.getting_started/7.3.camera.fs");
