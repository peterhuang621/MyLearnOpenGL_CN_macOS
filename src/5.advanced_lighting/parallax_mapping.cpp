...
const char *path = "/Users/peterhuang98/test_code/C++/learn_opengl/src/5.advanced_lighting/";
string addpath(const char *s)
{
    return string(path) + string(s);
}
...
void renderQuad()
{
    if (quadVAO == 0)
    {
        ...
        glm::vec2 deltaUV1 = uv2 - uv1, deltaUV2 = uv3 - uv1;
        ...
        float quadVertices[] = {pos1.x, pos1.y,     pos1.z,     nm.x,       nm.y,         nm.z,         uv1.x,
...
int main(int argc, char const *argv[])
{
    ...
    Shader shader(addpath("5.1.2.parallax_mapping.vs"), addpath("5.1.2.parallax_mapping.fs"));
    unsigned diffuseMap = loadTexture("/Users/peterhuang98/test_code/C++/learn_opengl/resources/textures/bricks2.jpg"),
             normalMap =
                 loadTexture("/Users/peterhuang98/test_code/C++/learn_opengl/resources/textures/bricks2_normal.jpg"),
             heightMap =
                 loadTexture("/Users/peterhuang98/test_code/C++/learn_opengl/resources/textures/bricks2_disp.jpg");
