...
int main(int argc, char const *argv[])
{
    ...
    Shader shader(addpath("3.2.1.point_shadows.vs"), addpath("3.2.1.point_shadows.fs"));
    Shader simpleDepthShader(addpath("3.2.1.point_shadows_depth.vs"), addpath("3.2.1.point_shadows_depth.fs"),
                             addpath("3.2.1.point_shadows_depth.gs"));
    ...
    shader.use();
    shader.setInt("difffuseTexture", 0);
    shader.setInt("depthMap", 1);

    glm::vec3 lightPos(0.0f, 0.0f, 0.0f);
    float near_plane = 1.0f, far_plane = 25.0f, currentFrame;
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // Serious confusion here! Pay attentions as lightPos is not constant as its z has changed!!!
        shadowTransforms.clear();
        shadowTransforms.emplace_back(
        ...
        // SHADOW_W/H is different from SCR_W/H!!! Pay attentions!!!
