...
float planeVertices[] = {25.0f, -0.5f, 25.0f, 0.0f,  1.0f,   0.0f,  25.0f,  0.0f, -25.0f, -0.5f, 25.0f,  0.0f,
...
unsigned cubeVAO = 0, cubeVBO = 0, quadVAO = 0, quadVBO;
...
int main(int argc, char const *argv[])
{
    ...
    Shader shader(addpath("3.1.2.shadow_mapping.vs"), addpath("3.1.2.shadow_mapping.fs"));
    Shader simpleDepthShader(addpath("3.1.1.shadow_mapping_depth.vs"), addpath("3.1.1.shadow_mapping_depth.fs")),
        debugDepthQuad(addpath("3.1.1.debug_quad.vs"), addpath("3.1.1.debug_quad_depth.fs"));
    ...
    constexpr unsigned SHADOW_WIDTH = 1024, SHADOW_HEIGHT = 1024;
