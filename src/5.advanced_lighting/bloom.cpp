...
int main(int argc, char const *argv[])
{
    ...
    Shader shader(addpath("7.bloom.vs"), addpath("7.bloom.fs"));
    Shader shaderLight(addpath("7.bloom.vs"), addpath("7.light_box.fs"));
    Shader shaderBlur(addpath("7.blur.vs"), addpath("7.blur.fs"));
    Shader shaderBloomFinal(addpath("7.bloom_final.vs"), addpath("7.bloom_final.fs"));

    unsigned woodTexture = loadTexture("/Users/peterhuang98/test_code/C++/learn_opengl/resources/textures/wood.png");
    unsigned containerTexture =
    ...
    unsigned pingpongFBO[2], pingpongColorbuffers[2];
