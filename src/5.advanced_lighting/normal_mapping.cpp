...
int main(int argc, char const *argv[])
{
    ...
    Shader shader(addpath("4.normal_mapping.vs"), addpath("4.normal_mapping.fs"));
    unsigned diffuseMap =
                 loadTexture("/Users/peterhuang98/test_code/C++/learn_opengl/resources/textures/brickwall.jpg"),
             normalMap =
                 loadTexture("/Users/peterhuang98/test_code/C++/learn_opengl/resources/textures/brickwall_normal.jpg");
