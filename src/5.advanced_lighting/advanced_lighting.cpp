...
int main(int argc, char const *argv[])
{
    ...
    Shader shader(addpath("1.advanced_lighting.vs"), addpath("1.advanced_lighting.fs"));
    ...
    unsigned floorTexture = loadTexture("/Users/peterhuang98/test_code/C++/learn_opengl/resources/textures/wood.png");
    shader.use();
    ...
    cout << "fbW=" << fbWidth << " fbH=" << fbHeight << endl;
