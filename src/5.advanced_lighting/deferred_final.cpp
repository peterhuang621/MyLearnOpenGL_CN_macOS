...
int main(int argc, char const *argv[])
{
    ...
    Shader shaderGeometryPass(addpath("8.2.g_buffer.vs"), addpath("8.2.g_buffer.fs"));
    Shader shaderLightingPass(addpath("8.2.deferred_shading.vs"), addpath("8.2.deferred_shading.fs"));
    Shader shaderLightBox(addpath("8.2.deferred_light_box.vs"), addpath("8.2.deferred_light_box.fs"));

    Model backpack("/Users/peterhuang98/test_code/C++/learn_opengl/resources/objects/backpack/backpack.obj");
